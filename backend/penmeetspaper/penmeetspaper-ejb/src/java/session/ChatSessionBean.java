  ...
  public List<Chat> getPersonsChat(Long personId) {
    ...
    for (Chat c : chats) {
      ...
      for (Person p : chatParticipants) {
        ...
        p.setOwnedCommunities(null);
        p.setFollowingCommunities(null);
      }
      ...
      for (Message m : chatMessages) {
        ...
        m.getSender().setOwnedCommunities(null);
        m.getSender().setFollowingCommunities(null);
        ...
        m.getRecipient().setOwnedCommunities(null);
        m.getRecipient().setFollowingCommunities(null);
      }
    }
