...
public class BadgeSessionBean implements BadgeSessionBeanLocal {
    ...
    public void createBadges() {
        ...
        topCommenter.setValueRequired(0);
        ...
        topStreamer.setValueRequired(0);
        ...
        topFollower.setValueRequired(0);
