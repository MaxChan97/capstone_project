...
public class PersonSessionBean implements PersonSessionBeanLocal {
  ...
  @Override
  public Person resetPassword(String email) throws NoResultException, NotValidException {
    
    Person oldPerson = emGetPersonByEmail(email);
    ...
    oldPerson.setPassword(newPassword);
    updatePerson(oldPerson);
    
    Person newPerson = emGetPerson(oldPerson.getId());
    return newPerson;
  }
