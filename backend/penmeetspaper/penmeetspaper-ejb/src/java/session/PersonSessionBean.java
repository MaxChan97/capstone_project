...
public class PersonSessionBean implements PersonSessionBeanLocal {
    ...
    public Person createPerson(Person person) throws NotValidException {
        ...
        // Set person's analytics
        FollowersAnalytics followersAnalytics = analyticsSB.createFollowersAnalytics();
        SubscribersAnalytics subscribersAnalytics = analyticsSB.createSubscribersAnalytics();
        EarningsAnalytics earningsAnalytics = analyticsSB.createEarningsAnalytics();
        ViewersAnalytics viewersAnalytics = analyticsSB.createViewersAnalytics();
        person.setFollowersAnalytics(followersAnalytics);
        person.setSubscribersAnalytics(subscribersAnalytics);
        person.setEarningsAnalytics(earningsAnalytics);
        person.setViewersAnalytics(viewersAnalytics);

        // User onboarding data collector
    ...
    public void updatePricingPlan(Person person) throws NoResultException, NotValidException {
        ...
        oldPerson.setStripePrice(person.getStripePrice());
        em.flush();
