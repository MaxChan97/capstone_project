...
export default function UsersList() {
  ...
  const [confirmUnbanDialogOpen, setConfirmUnbanDialogOpen] = React.useState(
    false
  );
  ...
  function handleClick(id) {
    Api.getPersonById(id).done((currentPerson) => {
    ...
    if (currentPerson.isBannedFromLogin == false) {
      Api.banPersonFromLogin(currentUser, currentPerson.id, reason, null)
        .done((list) => {
          ...
          let template_params = {
            to_email: currentPerson.email,
            to_name: currentPerson.username,
            reason: reason,
          };
  ...
  const columns = [
    ...
    {
      field: "contributorPoints",
      headerName: "Contributor",
      width: 149,
      description: "Contributor points",
    },
    {
      field: "contentCreatorPoints",
      headerName: "Creator",
      width: 120,
      description: "Content Creator points",
    },
    ...
    },
    {
      ...
      filterable: false,
      description:
        "Blue means user is not banned from login. Pink means user is banned from login",
      renderCell: (params) => (
        <div>
