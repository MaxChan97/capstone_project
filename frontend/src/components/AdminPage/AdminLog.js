...
const rows = [
    ...
    { id: 3, adminLogsType: 'BAN_USER', dateCreated: '12/5/2021', description: "User posted investment scams that are potentially dangerous to other users. Banned from login" },
    { id: 4, adminLogsType: 'UNBAN_USER', dateCreated: '12/1/2021', description: "lorem ipsum" },
    { id: 5, adminLogsType: 'DELETE_POST', dateCreated: '12/1/2020', description: "User is deceiving others to generate a financial or personal benefit to the detriment of a third party or entity through investment or financial scams" },
    { id: 6, adminLogsType: 'DELETE_COMMENT', dateCreated: '11/3/2021', description: "lorem ipsum" },
